                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td id="tooltip-container0" class="d-flex">
                                                <a href="{{ route('category.edit',[$item->id]) }}" class="me-3 text-primary" data-bs-container="#tooltip-container0" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="mdi mdi-pencil font-size-18"></i></a>
