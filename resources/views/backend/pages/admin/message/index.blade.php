                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <h5 class="card-header mt-0 text-center">Bulk Message</h5>
                            ...
                            <div class="modal-dialog modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="post" id="message_sms_form" action="{{ route('send.sms')}}">
                                            @csrf
                                            <input type="hidden" name="message_id" value="2">
                                            <ul>
                                                @forelse ($subscribers as $item)
                                                <li>
                                                    <input type="checkbox" name="subscriber_id[]" value="{{ $item->id }}" required>
                                                    {{ $item->user->name }} | {{ $item->user->contact}}
                                                </li>
                                                @empty
                                                <p>No unpaid Subscribers Found</p>
                                                @endforelse
                                            </ul>
                                        </form>
                                    </div>
