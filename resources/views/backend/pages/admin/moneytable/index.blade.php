                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td id="tooltip-container0" class="d-flex">
                                            <form action="{{ route('moneytable.destroy',[$item->id]) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center">
                                        <p class="font-size-16">Total Money Till Now</p>

                                        <h3 class="font-size-50">{{$totalRMoney}}</h3>
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center">
                                        <p class="font-size-16">Total Advance Paid</p>

                                        <h3 class="font-size-50">{{$totalRadvance}}</h3>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center">
                                        <p class="font-size-16">Total Balance Remain</p>

                                        <h3 class="font-size-50">{{$totalRbalance}}</h3>
