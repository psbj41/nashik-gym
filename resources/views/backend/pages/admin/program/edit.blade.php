                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('program.update',[$program->id])}}" method="post">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" value="{{ $program->name }}" name="name"
                                            id="name">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" value="{{ $program->year }}" name="year"
                                            id="year">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" value="{{ $program->trainers }}" name="trainers"
                                            id="trainers">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" value="{{ $program->clients }}" name="clients"
                                            id="clients">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" type="text"  name="about"
                                            id="elm1">{{ $program->about }}</textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12">
