                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td id="tooltip-container0" class="d-flex">
                                            @if( $item->status_sub == 'paid')
                                            <a href="{{ route('invoice.index',[$item->id]) }}" class="me-3 text-primary"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center">
                                        <p class="font-size-16">Total Subscription Price</p>

                                        <h3 class="font-size-50">{{$totalMoney}}</h3>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center">
                                        ...
                                        <h3 class="font-size-50">{{$totaladvance}}</h3>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center">
                                        ...
                                        <h3 class="font-size-50">{{$totalbalance}}</h3>
