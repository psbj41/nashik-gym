                ...
                <div class="col-sm-6">
                    <div class="page-title">
                        ...
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Testimonials Tables</li>
                        </ol>
                    </div>
                </div>
                <div class="col-sm-6">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            href="{{ $item->testimg }}"><img src="{{ $item->testimg }}" alt="{{ $item->name }}" class="img-fluid rounded-circle header-profile-user" width="50px">
                                            </a>
                                        </td>
                                        <td>{{ $item->name }}</td>
                                        <td>{{ $item->type }}</td>
