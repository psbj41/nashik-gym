                ...
                <div class="col-sm-6">
                    <div class="page-title">
                        ...
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Timetables Tables</li>
                        </ol>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="float-end  d-sm-block">
                        <a href="{{ route('timetable.create') }}" class="btn btn-success">Add New Timetable</a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td id="tooltip-container0" class="d-flex">
                                                <a href="{{ route('timetable.edit',[$item->id]) }}" class="me-3 text-primary" data-bs-container="#tooltip-container0" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="mdi mdi-pencil font-size-18"></i></a>
