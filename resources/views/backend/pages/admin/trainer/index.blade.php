                ...
                <div class="col-sm-6">
                    <div class="page-title">
                        ...
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Trainers Tables</li>
                        </ol>
                    </div>
                </div>
                <div class="col-sm-6">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td id="tooltip-container0" class="d-flex">
                                            <a href="{{ route('trainer.edit',[$item->id]) }}" class="me-3 text-primary"
                                        ...
                                        <td>{{ $item->twi }}</td>
                                        <td>
                                            <a class="image-popup-no-margins" href="{{ $item->tpimg }}">
                                                <img class="img-fluid rounded-circle header-profile-user" alt=""
                                                    src="{{ $item->tpimg }}" width="50" height="50">
                                            </a>
                                        </td>
                                        <td>
                                            <a class="image-popup-no-margins" href="{{ $item->tsimg }}">
                                                <img class="img-fluid rounded-circle header-profile-user" alt=""
                                                    src="{{ $item->tsimg }}" width="50" height="50">
                                            </a>
                                        </td>
                                        <td>
                                            <a class="image-popup-no-margins" href="{{ $item->tcertimg }}">
                                                <img class="img-fluid rounded-circle header-profile-user" alt=""
                                                    src="{{ $item->tcertimg }}" width="50" height="50">
                                            </a>
                                        </td>
                                        <td>
                                            {!! $item->about !!}
