...
@section('title')
Personal Trainer Subscription Create
@endsection
                ...
                <div class="col-sm-6">
                    <div class="page-title">
                        ...
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"> Personal Trainer Subscription Create Form</li>
                        </ol>
                    </div>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('tsub.store')}}" method="post">
                                @csrf
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" placeholder="499" name="price"
                                            id="price">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" placeholder="499" name="txn"
                                            id="txn">
                                    </div>
                                </div>
                                <div class="row mb-3">
