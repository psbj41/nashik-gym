                 ...
                 <div class="page-title">
                     <h4>Invoice</h4>
                         <ol class="breadcrumb m-0">
                             ...
                             <li class="breadcrumb-item active">Personal Training Invoice</li>
                         </ol>
                 </div>
             </div>
         </div>
                            ...
                            <div class="row" >
                                <div class="col-12">
                                    <div class="invoice-title">
                                        <h4 class="float-end font-size-16"><strong>Order # {{$tsub->user->id}}|{{ $tsub->updated_at->format('d M') }}</strong></h4>
                                        <h3 class="m-t-0">
                            ...
                            <div class="row" >
                                <div class="col-12">
                                    <div class="panel panel-default">
                                        <div class="p-2">
                                            <h3 class="panel-title font-size-20"><strong>Personal Training Details</strong></h3>
                                        </div>
                                        <div class="">
                                            <div class="table-responsive">
                                                <table class="table">
                                                    <tr>
                                                        Trainer Name: {{ $tsub->trainer->name }} <br>
                                                        Amount of Training: {{ $tsub->price }} <br>

                                                        @if ($tsub->advance !== 0)
                                                        Advance Amount: {{ $tsub->advance }} <br>
                                                        @endif

                                                        @if ($tsub->balance !== 0)
                                                        Balance Amount: {{ $tsub->balance }} <br>
                                                        @endif
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="no-line text-end"><h4 class="m-0">Rs. {{$tsub->price }}/-</h4></td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </div>
