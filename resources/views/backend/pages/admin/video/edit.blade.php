                ...
                <div class="col-sm-6">
                    <div class="page-title">
                        ...
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Video Edit Form</li>
                        </ol>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="float-end  d-sm-block">
                        <a href="{{ route('video.index') }}" class="btn btn-success">All Videos</a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" type="text" name="title"
                                            id="name" required>{{$video->title}}</textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="name" class="col-sm-2 col-form-label">video Title</label>
                                    <div class="col-sm-10">
                                        <select class="form-control" type="text" name="category_id"
                                            ...
                                            @foreach ($category as $item)
                                                <option value="{{$item->id}}" @if($item->id == $video->category_id) selected @endif>{{$item->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" type="text" name="link"
                                            id="name" required>{{$video->link}}</textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12">
