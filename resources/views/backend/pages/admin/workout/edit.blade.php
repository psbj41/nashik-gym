                ...
                <div class="col-sm-6">
                    <div class="page-title">
                        ...
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Workout Edit Form</li>
                        </ol>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="float-end  d-sm-block">
                        <a href="{{ route('workout.index') }}" class="btn btn-success">All Categorys</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('workout.update',[$workout->id])}}" method="post">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" value="{{$workout->name}}" name="name"
                                            id="name" required>
                                    </div>
                                </div>
                                <div class="col-sm-12">
